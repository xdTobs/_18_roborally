...
function setupPolling() {
    let intervalId = setInterval(() => pollFn(), 4000);
...
async function getBoardAlternatives() {
    ...
    const empty = createSpace(SpaceType.EMPTY);

    const createBelt = (heading) => createSpace(SpaceType.SLOW_BELT, heading)
    const createCheckpoint = () => createSpace(SpaceType.CHECKPOINT)
    ...
    const boards = [
        {
            name: 'board1',
            spaces: [
                [createBelt(Heading.NORTH), {...empty}, {...empty}, {...empty}],
        ...
        },
        {
            ...
            spaces: [
                ...
                [createCheckpoint(), createBelt(Heading.NORTH), {...empty}, {...empty}],
                [{...empty}, {...empty}, {...empty}, {...empty}],
                [{...empty}, {...empty}, {...empty}, {...empty}],
                [{...empty}, {...empty}, {...empty}, {...empty}],
            ]
    ...
    return new Promise(resolve => resolve(boards));
}
